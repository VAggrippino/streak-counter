...
describe('streakCounter', () => {
    ...
    describe('with a pre-populated streak', () => {
        ...
        it('should increment the streak', () => {
            // It should increment because this is the day after the streak
        ...
        it('should save the incremented streak to localStorage', () => {
            ...
            const streakAsString = mockLocalStorage.getItem(key)
            // Normally you should wrap in try/catch in case the JSON is bad but
            // since we authored it we can skip here
